...
<img src="/线程五种运行状态.png" alt="线程五种运行状态" style="zoom:80%;" />
...
<img src="/案例：烧水泡茶.png" alt="案例：烧水泡茶" style="zoom:60%;" />
...
<img src="/线程安全问题.png" alt="线程安全问题" style="zoom:60%;" />
...
<img src="/Java内存模型.png" alt="Java内存模型" style="zoom:60%;" />
...
多个线程在临界区内执行，由于**代码的执行序列不同**（字节码的执行序列）而导致结果无法预测，称之发生了竞态条件
